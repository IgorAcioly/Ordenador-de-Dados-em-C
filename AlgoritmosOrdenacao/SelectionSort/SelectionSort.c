...
int menuSelectionSort(){
     
// Endereça os arquivos locais
    char *nomes_copia = "..\\ProjetoAPS\\AlgoritmosOrdenacao\\SelectionSort\\CopiaParaOrdenar\\nomes_compostos_copia.txt";
    char *nomes_ordenados = "..\\ProjetoAPS\\AlgoritmosOrdenacao\\SelectionSort\\CopiaOrdenada\\nomes_compostos_ordenado_selection.txt";
    int num_elementos;
    int opcao = 0;
